...
public sealed class QtiTransformQbCleanupTests
{
    [Fact]
    public void QbCleanup_CleansUpBasicQbMarkup()
    {
        const string input = """
        ...
        var result = QtiTransform.Create(input).QbCleanup().Xml();
        XmlAssert.Equal(result, expected);
    }

    [Fact]
    public void QbCleanup_ResetsOutcomeVariablesBeforeResponseProcessing()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-assessment-item>
    ...
    [Fact]
    public void QbCleanup_DoesNotWipeNonTextContentInLayoutColumns_Video()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-item-body class="defaultBody" xml:lang="nl-NL">
    ...
    [Fact]
    public void QbCleanup_DoesNotRemoveImagesWrappedInSpans()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-item-body class="defaultBody" xml:lang="nl-NL">
    ...
    [Fact]
    public void QbCleanup_PreservesTextInNestedSpans()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-item-body class="defaultBody" xml:lang="nl-NL">
    ...
    [Fact]
    public void QbCleanup_ExactRealWorldScenario()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-item-body class="defaultBody" xml:lang="nl-NL">
    ...
    [Fact]
    public void QbCleanup_PreservesQtiGapElementsInsideSpans()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-item-body xml:lang="nl-NL" xmlns:m="http://www.w3.org/1998/Math/MathML">
                               <qti-gap-match-interaction id="gapMatchScoring" response-identifier="RESPONSE" max-associations="0" shuffle="false">
                                 <qti-gap-text identifier="A" match-max="1"><span>rupsen</span></qti-gap-text>
                                 <qti-gap-text identifier="B" match-max="1"><span>koolplanten</span></qti-gap-text>
                                 <qti-gap-text identifier="C" match-max="1"><span>volwassen sluipwesp</span></qti-gap-text>
                                 <qti-gap-text identifier="D" match-max="1"><span>larven van sluipwesp</span></qti-gap-text>
    ...
    [Fact]
    public void QbCleanup_CleansUpUserSRVetBoldNesting()
    {
        const string input = """
                             <?xml version="1.0" encoding="UTF-8"?>
                             <qti-item-body xml:lang="nl-NL">
                               <div class="content">
                                 <p class="UserSRVet">
                                   <strong><span>Zelfstandig </span></strong>
                                   <span>wonen</span>
                                 </p>
                                 <strong>
                                   <p class="UserSRVet">
